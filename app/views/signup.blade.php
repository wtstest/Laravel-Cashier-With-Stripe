    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            <div style="float:right; font-size: 85%; position: relative; top:-27px">
                <h5>Already have an account? {{ HTML::link( '/login', 'Login' ) }}</h5>
            </div>
        </div>  
        <div class="panel-body" >
            {{ Form::open( [ 'route' => 'signup.store', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'subscription-form' ] )}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {{ Form::select( 'subscription' , [ 'wts2000000' => '(Gold) 108$ per Year', 'wts1000000' => '(Basic) 9$ per month' ], 'wts1000000', [ 'class' => 'form-control' ])}}
                    </div>
                </div>

                <div class="form-group">
                    {{ Form::label( 'full_name', 'Full Name', [ 'class' => 'col-md-3 control-label' ])}}
                    <div class="col-md-9">
                        {{ Form::text('full_name', '', [ 'class' => 'form-control', 'placeholder' => 'Please enter full name' ])}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        {{ Form::selectRange('year', 2015, 2029, 2015, [ 'class' => 'form-control', 'data-stripe' => 'exp-year' ])}}
                    </div>
                </div>
...
<script>
    Stripe.setPublishableKey('pk_test_iBWKmeeFqdLv4DCKOSFsVw4u');
    jQuery(function($) {
